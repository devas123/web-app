...
export class SearchService<T, U> {
    ...
    private _optionsLookup?:LookupFn<T,  U | U[]>;
    ...
    public get optionsLookup():LookupFn<T, U | U[]> | undefined {
        return this._optionsLookup;
    }

    public set optionsLookup(lookupFn:LookupFn<T,  U | U[]> | undefined) {
    ...
    public initialLookup(initial:U | U[]):LookupFnResult<T> | LookupFnResult<T[]> {
        ...
        return (this._optionsLookup as LookupFn<T, U | U[]>)(undefined, initial) as LookupFnResult<T>;
    }
