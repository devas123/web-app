import {AfterViewInit, Component, Input, OnDestroy, QueryList, Renderer2, ViewChildren} from '@angular/core';
...
export abstract class CalendarView implements AfterViewInit, OnDestroy {
  ...
  private readonly _documentKeyDownListener: () => void;

  protected constructor(renderer: Renderer2, viewType: CalendarViewType, ranges: CalendarRangeService) {
    this._type = viewType;
    this.ranges = ranges;
