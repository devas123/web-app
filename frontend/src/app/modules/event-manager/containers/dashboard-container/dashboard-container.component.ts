...
export class DashboardContainerComponent implements OnInit, OnDestroy {
  ...
  constructor(private router: Router, private store: Store<AppState>, private route: ActivatedRoute, private dashboardService: DashboardService) {
    this.subs.add(
      this.store.pipe(
  ...
  cancelConnect() {
    this.dashboardService.dropConnection();
  }
