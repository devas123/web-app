...
import {Category, CategoryBracketsStage, Competitor, Fight, FightResultOption, FightsEditorChange, HeaderDescription, Period, ScheduleRequirement} from '../../../commons/model/competition.model';
