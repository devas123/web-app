...
export const DASHBOARD_INIT_DASHBOARD_STATE_COMMAND = 'INIT_DASHBOARD_STATE_COMMAND';
export const DASHBOARD_DELETE_DASHBOARD_STATE_COMMAND = 'DELETE_DASHBOARD_STATE_COMMAND';
export const DASHBOARD_CONNECT_SOCKET = 'DASHBOARD_CONNECT_SOCKET';
export const DASHBOARD_DISCONNECT_SOCKET = 'DASHBOARD_DISCONNECT_SOCKET';
...
export const dashboardMatSelected = (matId: string) => ({
