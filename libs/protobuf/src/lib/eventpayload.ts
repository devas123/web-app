...
export interface RegistrationGroupAddedPayload {
  periodId: string;
  groups: RegistrationGroup[];
}

export interface RegistrationGroupCategoriesAssignedPayload {
  periodId: string;
  groupId: string;
  categories: string[];
}

export interface RegistrationGroupDeletedPayload {
  periodId: string;
  groupId: string;
}
...
export interface RegistrationPeriodAddedPayload {
  period?: RegistrationPeriod;
}

export interface RegistrationPeriodDeletedPayload {
  periodId: string;
}
...
function createBaseRegistrationGroupAddedPayload(): RegistrationGroupAddedPayload {
  return { periodId: '', groups: [] };
}

export const RegistrationGroupAddedPayload = {
  encode(
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRegistrationGroupAddedPayload();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): RegistrationGroupAddedPayload {
    return {
  ...
  toJSON(message: RegistrationGroupAddedPayload): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<RegistrationGroupAddedPayload>, I>>(
    object: I
  ): RegistrationGroupAddedPayload {
    const message = createBaseRegistrationGroupAddedPayload();
...
function createBaseRegistrationGroupCategoriesAssignedPayload(): RegistrationGroupCategoriesAssignedPayload {
  return { periodId: '', groupId: '', categories: [] };
}

export const RegistrationGroupCategoriesAssignedPayload = {
  encode(
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRegistrationGroupCategoriesAssignedPayload();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): RegistrationGroupCategoriesAssignedPayload {
    return {
      periodId: isSet(object.periodId) ? String(object.periodId) : '',
  ...
  toJSON(message: RegistrationGroupCategoriesAssignedPayload): unknown {
    const obj: any = {};
    message.periodId !== undefined && (obj.periodId = message.periodId);
  ...
  fromPartial<
    I extends Exact<DeepPartial<RegistrationGroupCategoriesAssignedPayload>, I>
  >(object: I): RegistrationGroupCategoriesAssignedPayload {
    const message = createBaseRegistrationGroupCategoriesAssignedPayload();
    message.periodId = object.periodId ?? '';
...
function createBaseRegistrationGroupDeletedPayload(): RegistrationGroupDeletedPayload {
  return { periodId: '', groupId: '' };
}

export const RegistrationGroupDeletedPayload = {
  encode(
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRegistrationGroupDeletedPayload();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): RegistrationGroupDeletedPayload {
    return {
      periodId: isSet(object.periodId) ? String(object.periodId) : '',
      groupId: isSet(object.groupId) ? String(object.groupId) : '',
    };
  ...
  toJSON(message: RegistrationGroupDeletedPayload): unknown {
    const obj: any = {};
    message.periodId !== undefined && (obj.periodId = message.periodId);
    message.groupId !== undefined && (obj.groupId = message.groupId);
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<RegistrationGroupDeletedPayload>, I>>(
    object: I
  ): RegistrationGroupDeletedPayload {
    const message = createBaseRegistrationGroupDeletedPayload();
    message.periodId = object.periodId ?? '';
...
function createBaseRegistrationPeriodAddedPayload(): RegistrationPeriodAddedPayload {
  return { period: undefined };
}

export const RegistrationPeriodAddedPayload = {
  encode(
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRegistrationPeriodAddedPayload();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): RegistrationPeriodAddedPayload {
    return {
  ...
  toJSON(message: RegistrationPeriodAddedPayload): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<RegistrationPeriodAddedPayload>, I>>(
    object: I
  ): RegistrationPeriodAddedPayload {
    const message = createBaseRegistrationPeriodAddedPayload();
    message.period =
...
function createBaseRegistrationPeriodDeletedPayload(): RegistrationPeriodDeletedPayload {
  return { periodId: '' };
}

export const RegistrationPeriodDeletedPayload = {
  encode(
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRegistrationPeriodDeletedPayload();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): RegistrationPeriodDeletedPayload {
    return {
      periodId: isSet(object.periodId) ? String(object.periodId) : '',
    };
  },

  toJSON(message: RegistrationPeriodDeletedPayload): unknown {
    const obj: any = {};
    message.periodId !== undefined && (obj.periodId = message.periodId);
    return obj;
  },
  ...
  fromPartial<
    I extends Exact<DeepPartial<RegistrationPeriodDeletedPayload>, I>
  >(object: I): RegistrationPeriodDeletedPayload {
    const message = createBaseRegistrationPeriodDeletedPayload();
    message.periodId = object.periodId ?? '';
    return message;
  },
