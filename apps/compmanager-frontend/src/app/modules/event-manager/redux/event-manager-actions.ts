...
export const EVENT_MANAGER_COMPETITION_IMAGE_LOADED = 'EVENT_MANAGER_COMPETITION_IMAGE_LOADED';
export const EVENT_MANAGER_COMPETITION_IMAGE_REMOVED = 'EVENT_MANAGER_COMPETITION_IMAGE_REMOVED';
...
export const eventManagerCompetitionImageLoaded = createAction(EVENT_MANAGER_COMPETITION_IMAGE_LOADED, props<{ image: string }>());
export const eventManagerCompetitionImageRemoved = createAction(EVENT_MANAGER_COMPETITION_IMAGE_REMOVED);
